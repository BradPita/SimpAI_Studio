...
class SceneInput:
    ...
    def INPUT_TYPES(s):
        return {"required": {
                    ...
                    "ip_image2": ("STRING", {"default": "None", "multiline": False}),
                    "ip_image3": ("STRING", {"default": "None", "multiline": False}),
                    ...
                    "cfg": ("FLOAT", {"default": 8.0, "min": 0.0, "max": 100.0}),
                    "steps": ("INT", {"default": 20, "min": 1, "max": 10000}),
                    "var_number": ("INT", {"default": 0, "min": -10000, "max": 10000, "step": 1}),
                    "var_number2": ("INT", {"default": 0, "min": -10000, "max": 10000, "step": 1}),
                    ...
                    "var_number7": ("INT", {"default": 0, "min": -10000, "max": 10000, "step": 1}),
                    "var_number8": ("INT", {"default": 0, "min": -10000, "max": 10000, "step": 1}),
                    "var_number9": ("INT", {"default": 0, "min": -10000, "max": 10000, "step": 1}),
                    "var_number10": ("INT", {"default": 0, "min": -10000, "max": 10000, "step": 1}),
                ...
                "optional": {
                    ...
                    "sampler": (SAMPLER_NAMES, {"default": SAMPLER_NAMES[0]}),
                    "scheduler": (SCHEDULER_NAMES, {"default": SCHEDULER_NAMES[0]}),
                    "video_duration": ("FLOAT", {"default": 0.0, "min": 0.0, "max": 86400.0, "step": 0.1}),
                }}
    RETURN_TYPES = ("STRING", "STRING", "STRING", "STRING", "STRING", "STRING", "INT", "INT", "FLOAT", "INT", "INT", "INT", "FLOAT", "FLOAT", "FLOAT", "FLOAT", "INT", "INT", "INT", "INT", "BOOLEAN", "BOOLEAN", "BOOLEAN", "BOOLEAN", "INT", "INT", "INT", "STRING", "STRING", "STRING", SAMPLER_NAMES, SCHEDULER_NAMES, "FLOAT", )
...
class LoadInputImage:
    ...
    def IS_CHANGED(s, image_name, image):
        ...
        if image!='None':
            ...
            m.update(b'LoadInputImage:None')
        return m.digest().hex()
