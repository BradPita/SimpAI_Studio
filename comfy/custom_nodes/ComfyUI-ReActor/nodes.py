...
REACTOR_MODELS_PATH = os.path.join(models_dir, "controlnet")
FACE_MODELS_PATH = REACTOR_MODELS_PATH #os.path.join(REACTOR_MODELS_PATH, "faces")
NSFWDET_MODEL_PATH = os.path.join(models_dir, "safety_checker","vit-base-nsfw-detector")
...
dir_facerestore_models = os.path.join(models_dir, "controlnet", "facerestore_models")
