...
supported_text_encoder_extensions: set[str] = supported_pt_extensions | {'.gguf'}
supported_detection_extensions: set[str] = supported_pt_extensions | {'.onnx'}
...
def reset_folder_names_and_paths(models_root):
    ...
    folder_names_and_paths["text_encoders"] = ([os.path.join(models_dir, "text_encoders"), os.path.join(models_dir, "clip")], supported_text_encoder_extensions)
    ...
    folder_names_and_paths["detection"] = ([os.path.join(models_dir, "detection")], supported_detection_extensions)
