...
packages = {'base_package': {'id': 1,
 ...
 'wan_infinitetalk': {'id': 37, 'name': '[37]Wan-InfiniteTalk对口型预置包',
                        ...
                        "preset_sample": []},
 'ltx2.3_package': {'id': 38, 'name': '[38]LTX2.3文生、图生音视频和视频配音预置包',
 ...
 'pose_studio_sam3d_body_package': {'id': 42,
                                    'name': '[42]Pose Studio SAM 3D Body姿势解析模型包|显存需求：★★★☆ 速度：★★',
 ...
 'gaussian_studio_sharp_package': {'id': 43,
                                   'name': '[43]Gaussian Studio SHARP 3DGS模型包|显存需求：★★★☆ 速度：★★',
 ...
 'bernini_r_package': {'id': 44,
                       'name': '[44]Bernini-R图像编辑/多图视频/视频编辑模型包|显存需求：★★★★☆ 速度：★',
