...
class Krea2(ForgeDiffusionEngine):
    ...
    def __init__(self, estimated_config, huggingface_components):
        ...
        self.text_processing_engine_krea2 = Krea2TextProcessingEngine(
    ...
    def get_learned_conditioning(self, prompt: "SdConditioning"):
        ...
        return self.text_processing_engine_krea2(prompt)

    @torch.inference_mode()
    def get_prompt_lengths_on_ui(self, prompt):
        token_count = len(self.text_processing_engine_krea2.tokenize([prompt])[0])
