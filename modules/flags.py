...
uov_list_flux = [disabled, subtle_variation, strong_variation, upscale_15, upscale_2, upscale_fast]
...
default_clip = 'Default (model)'

refiner_swap_method = 'joint'

default_input_image_tab = 'ip_tab'
input_image_tab_ids = ['ip_tab', 'uov_tab', 'inpaint_tab', 'enhance_tab']
...
scene_aspect_ratios_map = {
    ...
    "16:9": "16:9",
    "21:9": "21:9" }
scene_legacy_named_aspect_ratios_map = {
    "Vertical|9:16": scene_aspect_ratios_map["9:16"],
    "Portrait|4:5": scene_aspect_ratios_map["4:5"],
    "Photo|4:3": scene_aspect_ratios_map["4:3"],
    "Landscape|3:2": scene_aspect_ratios_map["3:2"],
    "Widescreen|16:9": scene_aspect_ratios_map["16:9"],
    "Cinematic|21:9": scene_aspect_ratios_map["21:9"] }
scene_aspect_ratios = list(scene_aspect_ratios_map.values())
...
def scene_aspect_ratios_derive(ar):
    ar = scene_legacy_named_aspect_ratios_map.get(ar, ar)
    if '|' in ar:
        return ar.split('|', 1)[1].strip()
    return ar
...
aspect_ratios_templates = ['SDXL', 'Common', 'Flux', 'Wan']
default_aspect_ratio = ['832*1216', '1280*768', '1280*720', '832*1216']
...
resolution_quantize_steps = [1, 8, 16, 32, 64]
resolution_edit_mode_proportional = 'proportional'
resolution_edit_mode_crop = 'crop'
resolution_edit_mode_scale = 'scale'
resolution_edit_mode_pad = 'pad'
resolution_edit_mode_fill = resolution_edit_mode_scale
resolution_edit_modes = [
    resolution_edit_mode_proportional,
    resolution_edit_mode_crop,
    resolution_edit_mode_scale,
    resolution_edit_mode_pad,
]
default_resolution_quantize_step = 8
